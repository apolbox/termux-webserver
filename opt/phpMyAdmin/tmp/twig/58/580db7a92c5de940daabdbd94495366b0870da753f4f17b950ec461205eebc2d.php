...
($context["allow_user_drop_database"] ?? null)]));
    ...
    {
        return new Source("", "server/databases/databases_header.twig", "/data/data/com.termux/files/usr/opt/phpmyadmin/templates/server/databases/databases_header.twig");
    }
}
